...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel fixed-top" style="background-color: #f9f9f9">
            <div class="container">
                    {{-- Logo --}}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto" style="font-family:'Montserrat', sans-serif; margin-right: 10px; margin-left: 120px;">
                        ...
                        <li class="nav-item mr-2">
                            <a href="#rooms" class="nav-link" data-role="smoothscroll">Rooms</a>
                        </li>
                        <li class="nav-item mr-2">
                            <a href="#contact" class="nav-link" data-role="smoothscroll">Contact</a>
                        </li>
                    </ul>
